  ...
  return (
    <section className="relative overflow-hidden hero-minus-header flex items-center">
      <div aria-hidden="true" className="pointer-events-none absolute inset-0">
        <svg
          className="absolute inset-0 h-full w-full text-zinc-200/60"
        ...
        <div className="absolute left-1/2 top-[640px] -translate-x-1/2">
          <div className="amurot-parallax" data-parallax-layer="18">
            <div className="amurot-float h-[520px] w-[520px] rounded-full bg-linear-to-br from-sky-300/30 via-cyan-200/10 to-violet-300/30 blur-3xl"></div>
          </div>
        </div>
        <div className="absolute right-[-120px] top-20">
          <div className="amurot-parallax" data-parallax-layer="12">
            <div className="amurot-float-slower h-[420px] w-[420px] rounded-full bg-linear-to-br from-violet-300/22 via-sky-200/10 to-cyan-200/22 blur-3xl"></div>
          </div>
        </div>
        <div className="absolute -left-40 top-[220px]">
          <div className="amurot-parallax" data-parallax-layer="10">
            <div className="amurot-float h-[460px] w-[460px] rounded-full bg-linear-to-br from-cyan-200/20 via-sky-200/10 to-violet-200/20 blur-3xl"></div>
          </div>
        </div>
      </div>
      ...
      <div className="relative mx-auto max-w-6xl px-6 py-24 md:py-32">
        <div className="mx-auto max-w-2xl text-center">
          <h1 className="amurot-reveal text-balance text-4xl font-medium tracking-tight text-zinc-950 md:text-6xl">
          ...
          <p
            className="amurot-reveal mt-5 text-pretty text-base leading-relaxed text-zinc-600 md:text-lg"
      ...
      <div
        className="pointer-events-none absolute left-0 right-0 bottom-0 h-40 w-full z-20"
        style={{ background: 'linear-gradient(to bottom, rgba(255,255,255,0) 60%, #fff 100%)' }}
      ></div>
    </section>
  );
}
